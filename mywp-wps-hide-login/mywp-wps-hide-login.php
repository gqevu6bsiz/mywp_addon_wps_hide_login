...
final class MywpWPSHideLogin {
  ...
  private static function include_core() {
    ...
    $dir = MYWP_WPS_HIDE_LOGIN_PLUGIN_PATH . 'core/';
  ...
  public static function mywp_controller_plugins_loaded_include_modules( $includes ) {
    ...
    $dir = MYWP_WPS_HIDE_LOGIN_PLUGIN_PATH . 'controller/modules/';

    $includes['wps_hide_login_main_general'] = $dir . 'mywp.controller.module.main.general.php';
    $includes['wps_hide_login_updater']      = $dir . 'mywp.controller.module.updater.php';
